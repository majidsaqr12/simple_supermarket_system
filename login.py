...
pro.geometry('800x450+280+100') # width and hight of windows ( width , hight , left , up )
pro.resizable(False,False) #close minizum

pro.title("SUBERMARKET")# ( TITLE )s
#pro.iconbitmap('/home/majidsaqr/Desktop icon.icon')
